...
let users = [{
  ...
  description: '混双',
  id1: '4',
  avatar1: 'https://images.unsplash.com/photo-1548532928-b34e3be62fc6?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ',
  name1: '炽羽',
  description1: 'Animi eius expedita, explicabo',
}, {
  id: '2',
...
function Team() {
  ...
  return (<div className={`${style.matching} `}>
    ...
    <div className="header horizontal-left">
      <span className="title">选择队伍</span>
    ...
    <List header="我的队伍">
      ...
      >
        ...
        <Button className={'challenge-btn'} onClick={handleChallenge.bind(this, user.id)}>去挑战</Button>
      </List.Item>))}
    </List>
  </div>);
}
